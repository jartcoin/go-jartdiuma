...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gjart.ipc", false, filepath.Join(os.TempDir(), "gjart.ipc")},
		{"data", "gjart.ipc", false, "data/gjart.ipc"},
		{"data", "./gjart.ipc", false, "./gjart.ipc"},
		{"data", "/gjart.ipc", false, "/gjart.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gjart.ipc", true, `\\.\pipe\gjart.ipc`},
		{"data", "gjart.ipc", true, `\\.\pipe\gjart.ipc`},
		{"data", `\\.\pipe\gjart.ipc`, true, `\\.\pipe\gjart.ipc`},
	}
