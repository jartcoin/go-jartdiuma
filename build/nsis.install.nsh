Name "gjart ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/jartcoin/go-jartdiuma/issues"
!define UPDATEURL "https://github.com/jartcoin/go-jartdiuma/releases"
!define ABOUTURL "https://github.com/jartcoin/go-jartdiuma#ethereum-go"
...
# Install gjart binary
Section "Gjart" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gjart}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gjart.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gjart.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gjart incoming peers (TCP:33360)"
  SimpleFC::AdvRemoveRule "Gjart outgoing peers (TCP:33360)"
  SimpleFC::AdvRemoveRule "Gjart UDP discovery (UDP:33360)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gjart incoming peers (TCP:33360)" ""  6 1 1 2147483647 1 "$INSTDIR\gjart.exe" "" "" "Ethereum" 33360 "" "" ""
  SimpleFC::AdvAddRule "Gjart outgoing peers (TCP:33360)" ""  6 2 1 2147483647 1 "$INSTDIR\gjart.exe" "" "" "Ethereum" "" 33360 "" ""
  SimpleFC::AdvAddRule "Gjart UDP discovery (UDP:33360)" "" 17 2 1 2147483647 1 "$INSTDIR\gjart.exe" "" "" "Ethereum" "" 33360 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gjart.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gjart.ipc"
